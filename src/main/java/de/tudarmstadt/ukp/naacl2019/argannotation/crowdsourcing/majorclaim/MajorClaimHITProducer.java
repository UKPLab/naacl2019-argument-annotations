...
/**
 * Produces HITs for MajorClaim annotations
 */
public class MajorClaimHITProducer
    extends AbstractHITProducer
{
        ...
        throws IOException
    {
        ...
        List<String> rawTextList = createRawList(JCasUtil.selectSingle(aJCas, ReviewBody.class));
        List<String> rawTitleList = createRawList(JCasUtil.selectSingle(aJCas, ReviewTitle.class));

        // Prepare the HIT
        MajorClaimHITContainer hitContainer = new MajorClaimHITContainer();
        if (this.useSandbox) {
        ...
        // Render the template
        File outputHITFile = new File(outputDir, "hit-majorClaim-review-" + reviewID + ".html");
    ...
    {
        return TEMPLATE_DIRECTORY + "/mturk-template-majorclaim-" + language + ".html";
    }
    ...
    {
       new MajorClaimHITProducer().doMain(args);
    }
