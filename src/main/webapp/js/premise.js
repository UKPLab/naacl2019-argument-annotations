...
function highlighting(){
    ...
    if (selected.length > 0) {
        ...
        if (selectedVal.indexOf("false") !== -1 || selectedVal.indexOf("nonsense") !== -1) {
            return false;
        }
    }
...
$(document).ready(function() {
    ...
    $("#button_submit").hide();
    var el = document.getElementById('text_premise');
...
text
        ...
        $("#divBecause").append("<div id=\"annotated_premise"+count+"\"><p class=\"premise because_box answers inputbox\" id=\"infocus"+"\"><em>"+because_filler+" </em><span id='textAnnotated"+count+"'>"+filler+"</span> " +
        "" + "<span id=\'close\' class='delete because'>x</span>" + "</p></div>");
		
		var exceptNew = document.getElementById('annotated_premise'+count);
    ...
    $(document).on('click','.delete',function(){
        ...
        var res = annotatedId.replace("annotated_premise", "");
    ...
    $('#add_but').click(function(){
        ...
        document.getSelection().removeAllRanges();
        $("#infocus").attr("id",count);
        $("#divBut").append("<div id=\"annotated_premise"+count+"\"><p class=\"premise but_box answers inputbox\" id=\"infocus"+"\"><em>"+but_filler+" </em></em><span id='textAnnotated"+count+"'>"+filler+"</span> " +
